...
async def list_datasets(
    ...
    return [
        DatasetResponse(
            ...
            excluded_row_count=d.excluded_row_count,
            class_count=d.class_count,
            split_summary=d.split_summary or {},
            source_start_at=d.source_start_at,
            source_end_at=d.source_end_at,
...
async def list_training_runs(
    ...
    return [
        TrainingRunResponse(
            ...
            training_row_count=t.training_row_count,
            validation_row_count=t.validation_row_count,
            test_row_count=t.test_row_count,
...
async def list_models(
    ...
    return [
        ModelResponse(
            ...
            label_policy_version=m.label_policy_version,
...
async def get_model(
    ...
    return ModelResponse(
        ...
        label_policy_version=model.label_policy_version,
...
async def get_model_metrics(
    ...
    return ModelMetricsResponse(
        ...
        calibration_metrics=model.calibration_metrics or {},
...
async def create_drift_report(
    ...
    return DriftReportResponse(
        ...
        prediction_drift=report.prediction_drift or {},
        class_distribution=report.class_distribution or {},
